@extends('layouts.app')
@section('title', 'Chi tiết đơn hàng #' . $order->order_number . ' — Vibe Fashion')
...
<div class="vibe-section">
    <div class="container-xl">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-4 border-bottom pb-3">
            <div>
                <h1 class="vibe-page-title mb-2">Đơn Hàng #{{ $order->order_number }}</h1>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-8">
                <div class="vibe-form-card mb-4">
                    <h2 class="vibe-form-section-title mb-4">Sản phẩm đã đặt</h2>
                ...
                <div class="vibe-form-card">
                    <h2 class="vibe-form-section-title mb-4">Lịch sử giao hàng</h2>
                    <div class="position-relative ms-3 border-start border-2 pb-2">
                        ...
                        <div class="position-relative ms-4 mb-4">
                            ...
                            <h6 class="fw-bold mb-1">Đã đặt hàng</h6>
                        ...
                        <div class="position-relative ms-4 mb-4">
                            ...
                            <h6 class="fw-bold mb-1">Đã xác nhận</h6>
                        ...
                        <div class="position-relative ms-4 mb-4">
                            ...
                            <h6 class="fw-bold mb-1 text-success">Giao hàng thành công</h6>
                        ...
                        <div class="position-relative ms-4 mb-4">
                            ...
                            <h6 class="fw-bold mb-1 text-danger">Đã hủy đơn hàng</h6>
                            <p class="text-muted vibe-text-sm mb-1">{{ $order->cancelled_at->format('d/m/Y H:i') }}</p>
                            @if($order->cancel_reason)<p class="text-muted vibe-text-sm mb-0 fst-italic">Lý do: {{ $order->cancel_reason }}</p>@endif
                        </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="vibe-form-card mb-4 bg-light">
                    <h2 class="vibe-form-section-title mb-3">Tóm tắt thanh toán</h2>
                    ...
                    <div class="d-flex justify-content-between mb-3 border-bottom pb-3">
                        ...
                        <span class="vibe-mono">{{ $order->shipping_fee > 0 ? number_format($order->shipping_fee, 0, '.', ',') . '₫' : 'Miễn phí' }}</span>
                    </div>
                    ...
                    <div class="mt-4 pt-3 border-top">
                        <span class="text-muted d-block mb-1 vibe-text-sm">Phương thức thanh toán:</span>
                        <span class="badge bg-dark">{{ strtoupper(str_replace('_', ' ', $order->payment_method)) }}</span>
                    </div>
                </div>

                <div class="vibe-form-card">
                    <h2 class="vibe-form-section-title mb-3">Thông tin giao hàng</h2>
                    ...
                    @if($order->notes)
                        <hr>
                        <p class="text-muted mb-1 vibe-text-sm">Ghi chú:</p>
